...
public class RssFeedParser {
    ...
    public static Channel parse(String rssFeed) throws XmlPullParserException, IOException {
        ...
        try {
            ...
            return feedParser.readChannel(rssFeed, parser);
    ...
    private Channel readChannel(String rssFeed, XmlPullParser parser) throws IOException, XmlPullParserException {
        ...
        return new Channel(rssFeed, title, description, link, imageUrl, episodes);
    }
    ...
    private String readImage(XmlPullParser parser) throws IOException, XmlPullParserException {
        ...
        // find image URL tag
        while( !parser.getName().equalsIgnoreCase(URL) )
            parser.nextTag();
        String image = readText(parser);

        // find end of IMAGE tag
        while(!(parser.getName() != null && parser.getName().equalsIgnoreCase(IMAGE)))
            parser.next();
    ...
    public static class ParseFeed extends AsyncTask<String, Void, Channel> {
