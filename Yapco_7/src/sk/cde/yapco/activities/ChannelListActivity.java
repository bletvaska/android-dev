...
import sk.cde.yapco.YapcoApplication;
...
public class ChannelListActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // refresh channels if
        if( prefs.getBoolean("pref_refresh_on_startup", false) && ((YapcoApplication) getApplication()).isFirstRun() ){
            this.repository.refreshAllChannels();
        }
